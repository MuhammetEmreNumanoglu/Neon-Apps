 ...
 * Dashboard Page
 * 
 * Uygulamanin ana sayfasi (Dashboard).
 * Istatistikler, aktiviteler ve hizli islemler burada listelenir.
 */
"use client";
    ...
    return (
        <AppLayout>
                ...
                <CardContent className="flex items-center gap-3">
                    ...
                    {csvFile && (
                        <div className="flex gap-2 items-center">
                            ...
                            <button onClick={() => { const a = document.createElement("a"); a.href = downloadUrl!; a.download = csvFile.name; a.click(); }} className="p-2 border rounded hover:bg-muted"><Download className="size-4" /></button>
                            <button onClick={() => setCsvFile(null)} className="p-2 border rounded hover:bg-muted text-destructive"><Trash2 className="size-4" /></button>
                        </div>
                    )}
                </CardContent>
            </BaseCard>
            ...
            <div className="grid gap-6 lg:grid-cols-3">
                ...
                <BaseCard className="lg:col-span-1">
                    ...
                    <CardContent className="space-y-4">
                        {announcements.map(a => (
                            <div key={a.id} className="p-3 border rounded bg-muted/20 hover:bg-muted/40 transition">
            ...
            <BaseCard>
                ...
                <CardContent><ActivityFeed events={activityEvents} maxItems={8} /></CardContent>
            </BaseCard>
